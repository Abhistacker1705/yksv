				...
				<article className="flex flex-col font-poppins">
					...
					<div className="flex flex-col justify-center gap-8">
						<div className="flex flex-col gap-4">
							<h2 className={`text-lg font-bold text-center leading-8`}>
								Vision
							</h2>
							<p className="text-center font-poppins">{missionvision.vison}</p>
						</div>
						<div className="flex flex-col justify-center gap-4">
							<h2 className={`pb-1.5 text-lg font-bold text-center leading-8`}>
								Mission
							</h2>
